...
priceContainers = function(){
  return document.querySelectorAll('#header_wallet_balance,.price:not(#cart_price_total), .discount_price,.discount_original_price, .discount_final_price,.search_price, .search_discount,.table-sales td:nth-child(5)');
};
